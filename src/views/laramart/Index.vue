<template>
  <v-app :style="{ background: $vuetify.theme.themes.dark.background }">
    ...
    <v-container>
      <v-row>
        <v-col cols="12" md="3">
          <v-card class="mb-2 pa-2 borderLeft" color="#4fc694">
          ...
          <v-card class="rounded-xl mt-2">
            <v-row>
              <v-col cols="12" md="4" sm="4" align="center">
                ...
                <v-btn fab icon><v-icon>fas fa-minus</v-icon></v-btn>
...
export default {
  components: {
    // Navbar: () => import("@/layout/sys/Navbar.vue"),
  },
  data() {
    return {
      user: null,
